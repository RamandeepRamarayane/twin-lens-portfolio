  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-24 px-6 md:px-12 lg:px-24 flex flex-col items-center overflow-hidden">
      ...
      {/* -----------------------------------------
          ...
          ----------------------------------------- */}
      <div className="relative w-full max-w-5xl text-center mb-24 flex flex-col items-center">
        
        {/* Background "Ghost" Text */}
        <div className="absolute -top-8 md:-top-16 left-1/2 -translate-x-1/2 w-full select-none pointer-events-none z-0">
          <span className="font-heading text-6xl md:text-8xl lg:text-[10rem] font-bold italic tracking-tighter text-[#a87b1e] opacity-40 whitespace-nowrap">
            THE STUDIO PROCESS
          </span>
          {/* Subtle accent arrow */}
          <svg className="absolute top-[80%] left-[20%] w-6 h-6 text-[#a87b1e] opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <h1 className="relative z-10 font-heading text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight text-text-main mb-6 leading-[1.05]">
          ...
          <span className="text-brand drop-shadow-glow">Precision.</span><br />
        ...
        <p className="relative z-10 font-body text-text-muted text-sm md:text-base leading-relaxed max-w-2xl mt-4">
          End-to-end post-production services designed to elevate narrative and commercial video work. We treat every frame as an essential part of the story.
        </p>
      </div>
        ...
        <div className="relative group bg-surface-low border border-ghost rounded-lg p-8 md:p-12 overflow-hidden hover:border-ghost-hover transition-all duration-500 lg:col-span-2 flex flex-col justify-between min-h-[400px]">
          ...
          <div className="relative z-10 mb-12">
            ...
            <p className="font-body text-sm text-text-muted leading-relaxed max-w-md">
              Transforming raw footage into cohesive, rhythmic narratives. We specialize in fast-paced commercial cuts, brand documentaries, and narrative short forms.
            </p>
          </div>
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-3 font-body text-xs text-text-muted">
              <li className="flex items-center gap-3">
                <span className="w-4 h-4 rounded-full border border-brand flex items-center justify-center text-brand">▶</span>
                Offline & Online Edits
              </li>
              <li className="flex items-center gap-3">
                <span className="w-4 h-4 rounded-sm border border-brand flex items-center justify-center text-brand">◩</span>
        ...
        <div className="relative group bg-surface-low border border-ghost rounded-lg p-8 md:p-10 hover:border-ghost-hover transition-all duration-500 flex flex-col justify-between min-h-[400px]">
          <div>
            ...
            <p className="font-body text-sm text-text-muted leading-relaxed">
              Crafting visual tone and mood. Our grading suite ensures color accuracy and creative expression, establishing the defining look for your project.
            </p>
          </div>
        ...
        <div className="relative group bg-surface-low border border-ghost rounded-lg p-8 md:p-12 hover:border-ghost-hover transition-all duration-500 lg:col-span-3 flex flex-col md:flex-row gap-8 md:gap-16 items-start md:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="font-body text-sm text-text-muted leading-relaxed max-w-xl">
              Elevating narratives with kinetic typography, 2D animations, and seamless UI/UX screen replacements. We integrate graphics invisibly or make them the star of the show.
            </p>
          </div>
          ...
          <div className="w-full md:w-auto md:border-l md:border-ghost md:pl-16">
             <ul className="space-y-4 font-body text-xs text-text-muted">
              <li className="flex items-center gap-3">
                <span className="w-4 h-4 border border-brand rounded-full flex items-center justify-center text-brand">∞</span>
                Kinetic Typography
              </li>
              <li className="flex items-center gap-3">
                <span className="w-4 h-4 border border-brand flex items-center justify-center text-brand">⬡</span>
                Screen Tracking & Comp
              </li>
              <li className="flex items-center gap-3">
                <span className="w-4 h-4 border border-brand flex items-center justify-center text-brand">T</span>
                Title Sequences
              </li>
            </ul>
          </div>
