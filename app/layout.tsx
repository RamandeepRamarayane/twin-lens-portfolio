...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
        <html lang="en">
            <body className={`${inter.variable} ${oswald.variable} ${patrickHand.variable} bg-background text-text-main min-h-screen font-body antialiased`}>
                <Navbar />
                {children}
            </body>
        </html>
